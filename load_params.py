...
def load_net():
    ...
    for [n, m] in net_data["nodeLines"]:
        ...
        net_data["res"][n, m] = (net.line['r_ohm_per_km'][net_data["nodeLines"].index((n, m))]) # spezifischer Widerstand
        net_data["length"][n, m] = (net.line['length_km'][net_data["nodeLines"].index((n, m))]) # Länge der Verbindungsstrecken
